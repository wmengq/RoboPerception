...
{
	//载入原始图   
	Mat image = imread("e.jpg");  //工程目录下应该有一张名为1.jpg的素材图
	//创建窗口   
...
{
	//载入原始图   
	Mat srcImage = imread("孔刘.jpg");  //工程目录下应该有一张名为1.jpg的素材图
