...
## 膨胀与腐蚀
    ...
    腐蚀和膨胀都是对白色（高亮）部分而言，不是黑色部分。膨胀是图像中的高亮部分进行膨胀，类似于"领域扩张"效果图拥有比原图更大的高亮部分：腐蚀是原图中的高亮部分被腐蚀，类似于“领域被蝉食”，效果图拥有比原图更小的高亮区域。
...
漫水算法是一种类似于PHOTOSHOP上魔法棒的算法，可以寻找和种子像素联通的相近色素点。
![10.1](2020-11-29-15-47-06.png)

## 图像的金字塔缩放

   利用高斯
![11.1](2020-11-29-15-58-51.png)

## 阀值化

![12.1](2020-11-29-16-31-30.png)

## 边缘检测计算

![13.1](2020-11-29-16-39-25.png)
...
//		描述：定义一些辅助宏 
//------------------------------------------------------------------------------------------------ 
# 15. define WINDOW_NAME1 "【原始图窗口】"			//为窗口标题定义的宏 
# 16. define WINDOW_NAME2 "【轮廓图】"					//为窗口标题定义的宏 
...
## 总结
   ...
   本次课学习了对图片的一些处理算法，包括模糊处理.膨胀腐蚀.线性滤波.形态学滤波。通过这些算法我们可以实现一些PS的基本操作。
