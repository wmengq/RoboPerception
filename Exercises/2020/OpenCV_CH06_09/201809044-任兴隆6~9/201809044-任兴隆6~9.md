...
#####实验心得：通过本次实验，我再次熟悉opencv和Visual Studio2019的环境配置，通过这几次对opencv的学习，能操作一些基本的图像显示，及其基本的图像处理，但仍有较多编程的知识学习，特别是这次霍夫线变换的算法不太理解，代码都是直接粘贴的，我应该对算法进行理解，再慢慢熟悉，只有这样才能提高自己
